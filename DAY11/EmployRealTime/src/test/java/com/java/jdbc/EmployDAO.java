...
public interface EmployDAO {
	...
	List<Employ> showEmployDao() throws ClassNotFoundException, SQLException, SQLException;
	Employ searchEmployDao(int empno) throws ClassNotFoundException, SQLException, SQLException;
